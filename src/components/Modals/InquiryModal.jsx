...
export default function InquiryModal({ isOpen, onClose, initialSubject = "" }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fadeIn">
      <div className="relative w-full max-w-lg bg-[#141414] border border-white/20 rounded-3xl overflow-hidden shadow-2xl">
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="pt-2 flex items-center justify-between gap-3">
                ...
                <button
                  type="submit"
                  className="bg-[#F5A623] hover:bg-[#FFB627] text-black font-bold text-sm px-6 py-2.5 rounded-full transition-all flex items-center gap-2 shadow-md shadow-[#F5A623]/20 active:scale-95"
                >
