  ...
  return (
    <div className="space-y-6 font-bengali">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-[#141414] border border-white/10 p-6 rounded-3xl shadow-xl">
        <div>
          <h2 className="text-xl font-extrabold text-white font-heading">আন্তর্জাতিক ব্র্যান্ডসমূহ ব্যবস্থাপনা</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {brands.map((brand, index) => (
          <div key={index} className="bg-[#141414] border border-white/10 p-6 rounded-2xl space-y-4 shadow-lg flex flex-col justify-between">
            <div className="space-y-3">
              ...
              <h3 className="text-lg font-bold text-white font-heading">{brand.name}</h3>
