  ...
  return (
    <div className="space-y-6 font-bengali">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-[#141414] border border-white/10 p-4 sm:p-5 rounded-2xl">
        <div>
          <h3 className="text-lg sm:text-xl font-bold text-white font-heading">জেনারেটর প্রোডাক্ট ক্যাটালগ</h3>
          <p className="text-xs text-gray-400">মোট প্রোডাক্ট: {products.length} টি</p>
        </div>

        <button
          onClick={handleOpenAdd}
          className="bg-[#F5A623] hover:bg-[#FFB627] text-black font-extrabold text-xs sm:text-sm px-5 py-3 rounded-xl sm:rounded-full transition-all flex items-center justify-center gap-2 shadow-md shadow-[#F5A623]/20"
        >
          <Plus size={18} />
      ...
      {modalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black/80 backdrop-blur-sm animate-fadeIn">
          <div className="relative w-full max-w-2xl bg-[#141414] border border-white/20 rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl max-h-[92vh] flex flex-col">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col flex-1 overflow-hidden">
              <div className="p-4 sm:p-6 overflow-y-auto space-y-4 flex-1">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-[#0E0E0E] border border-white/15 rounded-xl px-4 py-3 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-[#F5A623]"
                    />
                  </div>
                ...
                <div className="space-y-2.5 bg-[#0E0E0E] p-3.5 sm:p-4 rounded-2xl border border-white/10">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 items-center">
                    <input
                      ...
                      className="flex-1 w-full bg-[#141414] border border-white/15 rounded-xl px-4 py-3 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-[#F5A623]"
                    />

                    {/* Live Image Preview Frame */}
                    <div className="w-full sm:w-20 h-20 rounded-xl bg-[#141414] border border-[#F5A623]/30 p-1 flex items-center justify-center shrink-0 overflow-hidden shadow-inner">
                      <img
